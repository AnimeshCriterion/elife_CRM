...
public class InvoiceListAdapter extends RecyclerView.Adapter<InvoiceListAdapter.MyviewHolder>{
    ...
    public InvoiceListAdapter(Context context, List<PaymentRecieptList.PaymentReciept> paymentReciepts) {
    ...
    @NonNull
    @Override
    public InvoiceListAdapter.MyviewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_invoice_list, viewGroup, false);
        ...
        holder.cv_customer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // SharedPrefsData.putString(context, Constants.CustomerID, paymentReciepts.get(position).getCustomerID().toString(), Constants.PREF_NAME);
                context.startActivity(new Intent(context, BillShareActivity.class));
            }
        });
    }
