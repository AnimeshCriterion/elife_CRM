...
public interface EditReportContract {
    interface View {
        ...
        void updateResponse(InsertPayment insertPayment);
    ...
    interface Presenter {
        ...
        void updateComplaint(Context context, String Complaint_ID, String Company_ID, String Customer_ID, String Complaint_Code, String Complaint_Date, String Complaint_Type_ID,
