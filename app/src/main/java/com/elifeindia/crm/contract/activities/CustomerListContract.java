...
public interface CustomerListContract {
    ...
    interface Presenter {
        ...
        void loadCustomersDateWise(Context context, String Company_ID, String User_ID, String Employee_ID, String AreaId,  String StatusId, String count, String pageNo, String Value,String field_value,String field_name,String frmDate,String toDate);
    }
