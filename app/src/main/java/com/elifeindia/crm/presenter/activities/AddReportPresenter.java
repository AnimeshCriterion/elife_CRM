...
public class AddReportPresenter implements AddReportContract.Presenter {
    ...
    public AddReportPresenter(AddReportContract.View mView) {
        this.mView = mView;
    }
    ...
    @Override
    public void insertComplaint(Context context, String Complaint_ID, String Company_ID, String Customer_ID, String Complaint_Code, String Complaint_Date, String Complaint_Type_ID,
        ...
        if(NetCheck.isInternetConnection(context)) {
            NetworkUtils.getUserApiInstance()
                    .insertComplaint(Complaint_ID, Company_ID, Customer_ID, Complaint_Code, Complaint_Date, Complaint_Type_ID,
                    ...
                    .subscribe(new Subscriber<InsertPayment>() {
                        ...
                        public void onNext(InsertPayment complaintStatusList) {
                            mView.insertResponse(complaintStatusList);
                        }
                    });
        }else {
            mView.showError("Connection Error");
