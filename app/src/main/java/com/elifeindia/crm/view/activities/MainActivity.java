...
import com.elifeindia.crm.model.GiftitemPOJO;
...
public class MainActivity extends Activity {
  Button btnSendIntent, sendBtn;
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      txtphoneNo = (EditText) findViewById(R.id.edt_mob);
      txtMessage = (EditText) findViewById(R.id.edt_message);
      context = this;
