...
import com.elifeindia.crm.adapters.PaymentMasterForBillShareAdapter;
...
public class BillShareForCollectionAndCollect extends AppCompatActivity   {
    ...
    com.elifeindia.crm.adapters.PaymentMasterForBillShareAdapter paymentMasterForBillShareAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bill_share2);
...
//                    }
        ...
        // employeeNumber.setText(SharedPrefsData.getString(BillShareForCollectionAndCollect.this, Constants.EmployeeMob, Constants.PREF_NAME));
        ...
        findViewById(R.id.iv_back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPrefsData.putString(BillShareForCollectionAndCollect.this, Constants.ReceiptFlag, "true", Constants.ReceiptFlag);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPrefsData.putString(BillShareForCollectionAndCollect.this, Constants.ReceiptFlag, "true", Constants.ReceiptFlag);
                // SharedPrefsData.putString(BillShareForCollectionAndCollect.this, Constants.ReceiptFlag, "true",Constants.PREF_NAME);
             ...
             /*  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
               ...
               /* Bitmap bitmap = getBitmapFromView(svprint, svprint.getChildAt(0).getHeight(),
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    if (!EasyPermissions.hasPermissions(BillShareForCollectionAndCollect.this, BLUETOOTH_PERMISSIONS_S)) {
                        EasyPermissions.requestPermissions(BillShareForCollectionAndCollect.this, "message", 5, BLUETOOTH_PERMISSIONS_S);
                    } else {
                        findBTprint();
                    }
                } else {
...
//                }
     ...
     //   txt_invoice_date.setText(todayDateString());
        ...
        PaymentMasterRecylerViewRecyclerView.setAdapter(paymentMasterForBillShareAdapter);
